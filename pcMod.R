pcMod <- function (md, CP, M.exp, E.exp, T.exp, WS = 0.25, method = "spearman",iqr.filter = c(log2(1.5), log2(1.5), log2(1.5)), cor.MvsCP = c(-0.3,0.3), cor.EvsT.dif = 0.3, cor.EvsT.abs = -0.3, CP.fc.filter = log2(1.5),CP.p.filter = 0.01, rand = 100, correction = "BH", cores = 1)
{
